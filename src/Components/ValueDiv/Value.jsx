...
const Value = () => {
  return (
    <div className='mb-[4rem] mt-[3rem]'>
        <h1 className='text-textColor text-[25px] py-[2rem] pb-[3rem] font-bold w-[400px] block'>The value that holds us to true and to account</h1>

        <div className='grid gap-[10rem] grid-cols-3 items-center'>
            <div className='singleGrid rounded-[10px] hover:bg-[#f7edf7] p-[1.5rem]'>
            ...
            <div className='singleGrid rounded-[10px] hover:bg-[#fdeff4] p-[1.5rem]'>
                <div className='flex items-center gap-3'>
                    <div className='imgDiv p-[4px] rounded-[.8rem] bg-[#fdd8ff] h-[40px] w-[40px] flex items-center justify-center'>
                ...
                <p className='text-[12px] text-textColor opacity-[.7] py-[1rem] font-semibold' >
                   We believe in making things better for everyone , even if it  means going against the grain a little bit💗.
                </p>
        ...
        <div className="card mt-[2rem] flex justify-between bg-blueColor p-[5rem] bg-cover rounded-[10px]">
