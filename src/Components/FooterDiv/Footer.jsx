...
const Footer = () => {
  return (
    <div className='footer p-[5rem] mb-4 bg-blueColor rounded-[10px] gap-[10] grid grid-cols-5 m-auto items-start justify-center'>
        ...
        <p className='text-white pb-[13px] opacity-70 leading-7 w-[180px]'>
            We always make our companies and seeker find the best jobs and employers find the best candidates.
        </p>
        </div>
        ...
        <div className='grid'>
            ...
            <div >
                <small className='text-[14px] text-white'>
                    malikishita@outlook.com
                    </small> 
                    <div className='icons flex gap-4 py-4'>
    <AiFillInstagram className='bg-white p-2 h-[35px] w-[35px] rounded-full icon text-blue-500'/>
    <AiOutlineGithub className='bg-white p-2 h-[35px] w-[35px] rounded-full icon text-blue-500'/>
    <AiOutlineTwitter className='bg-white p-2 h-[35px] w-[35px] rounded-full icon text-blue-500'/>
</div>
